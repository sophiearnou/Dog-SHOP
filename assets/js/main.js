...
const sr = ScrollReveal({
    /*tu donnes une distance de ex:30px*/
    distance: '30px',
    /*duré de l'action*/
    duration: 1800,
    /*reset active / désactive le retour des éléments à leur position initialisée*/
    reset: true,
});
...
sr.reveal(`.home__data, .home__img, 
           ...
           .footer__content`, {
    origin: 'top',
    /*temps entre l'action*/
    interval: 200,
})

sr.reveal(`.share__img, .send__content`, {
    /*action qui vient de la gauche*/
    origin: 'left'
})
